...
import (
	...
	v1 "neelanjan.dev/operator-demo/api/v1"
)
...
//+kubebuilder:rbac:groups=tutorial.neelanjan.dev,resources=foos,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tutorial.neelanjan.dev,resources=foos/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tutorial.neelanjan.dev,resources=foos/finalizers,verbs=update
